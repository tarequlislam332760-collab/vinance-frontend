  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0b0e11] text-[#848e9c] font-sans select-none overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
        ...
        {/* --- Left Column: Order Book (Binance Style) --- */}
        <div className="w-full md:w-64 bg-[#161a1e] border-r border-gray-800 flex flex-col p-2">
          ...
          <div className="space-y-[1px] mb-4">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="flex justify-between text-[12px] relative h-5 items-center px-1">
                <div className="absolute inset-0 bg-[#f6465d]/10 text-right pr-1" style={{ width: `${Math.random() * 80}%`, left: 'auto' }}></div>
          ...
          <div className="py-2 border-y border-gray-800 my-1 text-center">
            <div className="text-[#02c076] text-lg font-bold">{currentPrice}</div>
            <div className="text-[10px] text-gray-500">≈ {currentPrice}</div>
          </div>
          ...
          <div className="space-y-[1px]">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="flex justify-between text-[12px] relative h-5 items-center px-1">
                <div className="absolute inset-0 bg-[#02c076]/10" style={{ width: `${Math.random() * 80}%` }}></div>
        ...
        <div className="flex-1 flex flex-col bg-[#0b0e11]">
          ...
          <div className="h-64 overflow-y-auto bg-[#161a1e]">
            <div className="flex gap-6 border-b border-gray-800 px-4 py-2 text-[12px] font-bold">
              <span className="text-white border-b-2 border-[#f0b90b] pb-2">Positions(1)</span>
              <span className="text-gray-500">Open Orders(3)</span>
