...
// --- ৩. ট্রেড পেজ (ফিক্সড ব্যালেন্স আপডেট) ---
const TradePage = () => {
  ...
  const handleTrade = async () => {
    ...
    try {
      ...
      // ব্যাকএন্ড থেকে আসা নতুন ব্যালেন্স দিয়ে স্টেট আপডেট
    ...
    <div className="p-4 md:p-8 flex flex-col lg:flex-row gap-6">
      ...
      <div className="w-full lg:w-96 bg-[#1e2329] border border-gray-800 rounded-[2.5rem] p-8 shadow-2xl">
        ...
        <div className="flex justify-between text-[10px] font-bold text-gray-500 mb-2 uppercase tracking-widest">
            ...
            <span className="text-white">${user?.balance?.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
        </div>
